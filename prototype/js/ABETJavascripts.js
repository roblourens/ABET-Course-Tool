...
" <tr>"+
"        <td width='53'>1</td>"+
"        <td width='54'><select name='assignment_type_1' id='assignment_type_1'>"+
...
"        <td width='20'><input type='checkbox' name='checkbox3' id='checkbox3' /></td>"+
"        <td width='20'><input type='checkbox' name='checkbox4' id='checkbox4' /></td>"+
"        <td width='20'><input type='checkbox' name='checkbox5' id='checkbox5' /></td>"+
"        <td width='20'><input type='checkbox' name='checkbox6' id='checkbox6' /></td>"+
...
"        <td width='20'><input type='checkbox' name='checkbox11' id='checkbox11' /></td>"+
"      </tr>";
}
